# THIS FILE IS A DERIVATIVE OF email_dataset.py FOR GMAIL-SPECIFIC TESTS.
# The 'author' key has been replaced with 'from' to match the Gmail API schema.
...
# Additional spam-like examples for experimentation
email_input_17 = {
    "from": "Billing Dept <billing@unknownvendor.biz>",
    "to": "Lance Martin <lance@company.com>",
    "subject": "Invoice overdue: immediate action required",
    "body": """Hello,

Please find the attached invoice INV-00981 which is now overdue. Failure to pay within 24 hours will incur penalties.

View invoice: http://insecure-link.example/verify
...
email_input_18 = {
    "from": "Rewards Center <rewards@contest-prize.win>",
    "to": "Lance Martin <lance@company.com>",
    "subject": "Congratulations! You won an iPhone",
    "body": """Good news!

You have been selected to receive a brand new iPhone. Confirm your shipping address here:

http://click-here-now.example/claim
...
triage_output_17 = "ignore"
triage_output_18 = "ignore"
...
response_criteria_17 = """
• No response needed
• Ensure this is ignored (likely spam)  
"""

response_criteria_18 = """
• No response needed
• Ensure this is ignored (likely spam)  
"""
...
examples_triage = [
  ...
  {
      "inputs": {"email_input": email_input_17},
      "outputs": {"classification": triage_output_17},
  },
  {
      "inputs": {"email_input": email_input_18},
      "outputs": {"classification": triage_output_18},
  },
]
...
email_inputs = [
        ...
        email_input_16, email_input_17, email_input_18
    ]
...
response_criteria_list = [
    ...
    response_criteria_16, response_criteria_17, response_criteria_18
]
...
triage_outputs_list = [
    ...
    triage_output_16, triage_output_17, triage_output_18
]
...
expected_tool_calls = [
    ...
    [],                                                                      # email_input_17: Overdue invoice (spam-like) - ignore
    [],                                                                      # email_input_18: Prize scam (spam-like) - ignore
]
