...
5. google_search(query, num_results=5) - Search Google for recent information
...
4. google_search(query, num_results=5) - Search Google for recent information
5. Question(content) - Ask the user any follow-up questions
6. Done - E-mail has been sent
"""
