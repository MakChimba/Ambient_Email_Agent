...
- DeepWiki MCP integration: Available through `mcp.deepwiki` with tools `read_wiki_structure`, `read_wiki_contents`, and `ask_question` for quick GitHub repo documentation lookups.
